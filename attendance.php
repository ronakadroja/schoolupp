                        ...
                        <form method="post">
                            ...
                            <div id="mark_att" class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">All Students Attendance</h3>
                                </div>
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="standard">
                                                    <option disabled selected>Select Standard for Attendance</option>
                                                    <?php
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" name='att_date' class="form-control pull-right" id="datepicker" placeholder="Select Attendance Date">
                                    ...
                                    <div>
                                        <div class="form-group" style="justify-content:center; display:flex;">
                                            <button type="submit" style="margin-top:25px; text-align:center;" id="search" name="search" value="search" class="btn btn-primary">Search Attendance</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="styled-table" style="overflow-y :scroll;">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                $sql = "select * from attendance where standard = '{$_POST['standard']}' and att_date='". date_format(new DateTime($_POST['att_date']), 'd/m/Y') ."'";
                                                ...
                                                if ($r) {
                                                    ...
                                                    foreach ($r as $row) {
                                                        ...
                                                        echo "<tr><td>{$count}</td><td>" . $row['standard']  . "</td><td>{$row['stu_name']}</td><td>{$row['attendance']}</td></tr>";
                                                        $count++;
                                                    }
                                                }
                                                else{
