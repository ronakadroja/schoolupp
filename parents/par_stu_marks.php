...
$sql = "select * from parent where p_email = '" . $_SESSION['email'] . "'";
...
<body class="hold-transition skin-green sidebar-mini">
                        ...
                        <form method="post">
                            ...
                            <div id="mark_att" class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Exams Marks Details</h3>
                                </div>
                                        ...
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="subject">
                                                    ...
                                                    <?php
                                                    // $sql = "select * from subject where sub_standard in (select stu_std from student where stu_email = '" . $_SESSION['email'] . "' )";
                                                    $sql = "select * from subject where sub_standard in (select stu_std from student where stu_id in (select p_son from parent where p_email = '" . $_SESSION['email'] . "' ))";
                                        ...
                                        <table class="styled-table" style="overflow-y :scroll;">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_POST['search'])) {
                                                    ...
                                                    $sql = "select * from marks_entry where stu_id='$id' and subject='{$_POST['subject']}' and exam_type='{$_POST['exam_type']}' and exam_date='". date_format(new DateTime($_POST['exam_date']), 'd/m/Y') ."'";
  ...
  immediately after the control sidebar -->
    ...
    <script>
        ...
        var r = document.getElementById("par_stu_marks");
        r.className += "active";
