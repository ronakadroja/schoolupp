...
<div class="wrapper">
 ...
 <div class="col-xs-4">
    ...
    <label for="exampleFormControlTextarea1">Notice Title</label>
    <input type="text" name="n_title" class="form-control" id="exampleFormControlTextarea1" rows="10"></input>
  </div>
                    <div class="form-group">
    <label for="exampleFormControlTextarea1">Notice Description</label>
    <textarea name="n_desc" class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
  </div>
               ...
               // $day = $_POST['day'];
                 ...
                 //  $grade = $_POST['grade'];
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO notice(n_title,n_desc,odience,`date`) VALUES ('".$n_title."', '".$n_desc."','".$odience."', now())";
                ...
                <tbody>
                  ...
                  if ($rows) {
                   // output data of each row
                     foreach($rows as $row) {
                      echo "<tr><td> " . $row["id"]. " </td><td> " . $row["n_title"]." </td><td> " . $row["n_desc"]." </td><td> " . $row["date"]." </td>
