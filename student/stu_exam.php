...
<body class="hold-transition skin-green sidebar-mini">
                                                ...
                                                <table class="table table-striped table-bordered text-center">
                                                    ...
                                                    <tbody id="tbody">
                                                        <?php
                                                            ...
                                                            $sql = "select * from exam where standard='$std'";
                                                            ...
                                                            if ($tt) {
                                                                // output data of each row
                                                                foreach ($tt as $row) {
                                                                    echo "<tr><td> " . $row["exam_id"] . " </td><td> " . $row["exam_type"] . " </td><td> " . $row["standard"] . " </td><td>". $row["start_exam"] . "</td><td> " . $row["end_exam"] . " </td><td><a href='http://localhost/SMS/exam_timetables/{$row['exam_tt']}' target='_blank'><small class='label  bg-orange'>Preview</small></a></td></tr>";
                                                                }
                                                            }
                                                            else{
  ...
  immediately after the control sidebar -->
    ...
    <script>
        ...
        var r = document.getElementById("stu_exam");
        r.className += "active";
