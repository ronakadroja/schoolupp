...
$name = $dob = $contact = $gender = $email = $address = $class_tea = $tea_std = $skill = $status = "";

$update = "SELECT * FROM teacher WHERE email='" . $_SESSION['email'] . "'";
...
if ($rows) {
    ...
    foreach ($rows as $row) {
        ...
        $dob = date_format(new DateTime($row['bday']), 'd/m/Y');
...
if ($rows) {
    ...
    foreach ($rows as $row) {
        ...
        $tea_std .= $row['sub_standard'] . "(" . $row['sub_name'] . ") , ";
    }
}else{
    $tea_std = 'NO';
}
...
<body class="hold-transition skin-green sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Teacher Profile</h3>
                            </div>
                                ...
                                <table class="styled-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $tea_std ?></td>
                                        </tr>
                                        <tr>
                                            <td>Class Teacher</td>
                                            <td><?php echo $class_tea ?></td>
                                        </tr>
                                       
                                        <tr>
                                            <td>Acadamic Status</td>
                                            <td><?php if ($status == 'active') {
                                                    echo "<button class='btn btn-success'>Teaching</button>";
                                                } else {
  ...
  immediately after the control sidebar -->
    ...
    <script>
        ...
        var r = document.getElementById("tea_profile");
        r.className += "active";
